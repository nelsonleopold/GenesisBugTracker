...
namespace GenesisBugTracker.Data
{
    public static class DataUtility
    {
        ...
        public static string BuildConnectionString(string databaseUrl)
        {
            ...
            // Provide a simple way to create and manage the contents of connection strings used by the NpgsqlConnection class
        ...
        public static async Task SeedDefaultTicketsAsync(ApplicationDbContext context, UserManager<BTUser> userManager)
        {
            ...
            try
            {
                IList<Ticket> tickets = new List<Ticket>() {
                                ...
                                //ADDRESSBOOK       SubmitterUserId
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 1", Description = "Ticket details for address book ticket 1", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 2", Description = "Ticket details for address book ticket 2", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusDev, TicketTypeId = typeEnhancement},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 3", Description = "Ticket details for address book ticket 3", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 4", Description = "Ticket details for address book ticket 4", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 5", Description = "Ticket details for address book ticket 5", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusDev,  TicketTypeId = typeDefect},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 6", Description = "Ticket details for address book ticket 6", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew,  TicketTypeId = typeEnhancement},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 7", Description = "Ticket details for address book ticket 7", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 8", Description = "Ticket details for address book ticket 8", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusDev,  TicketTypeId = typeNewDev},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 9", Description = "Ticket details for address book ticket 9", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew,  TicketTypeId = typeDefect},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 10", Description = "Ticket details for address book ticket 10", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeEnhancement},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 11", Description = "Ticket details for address book ticket 11", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusDev,  TicketTypeId = typeChangeRequest},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 12", Description = "Ticket details for address book ticket 12", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew,  TicketTypeId = typeNewDev},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 13", Description = "Ticket details for address book ticket 13", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 14", Description = "Ticket details for address book ticket 14", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusDev,  TicketTypeId = typeEnhancement},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 15", Description = "Ticket details for address book ticket 15", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew,  TicketTypeId = typeChangeRequest},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 16", Description = "Ticket details for address book ticket 16", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 17", Description = "Ticket details for address book ticket 17", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusDev,  TicketTypeId = typeNewDev},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 18", Description = "Ticket details for address book ticket 18", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusDev,  TicketTypeId = typeEnhancement},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 19", Description = "Ticket details for address book ticket 19", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew,  TicketTypeId = typeChangeRequest},
                                new Ticket() {SubmitterUserId = company2AdminId, Title = "AddressBook Ticket 20", Description = "Ticket details for address book ticket 20", Created = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc), ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                };
